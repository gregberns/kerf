...
- Scenario-test item filed with ID `<id>` — creation point (see `jig-system.md` §Validation-test requirement)
- Exploratory-test item filed with ID `<id>` — creation point (see `jig-system.md` §Validation-test requirement)
...
- Scenario-test item with ID `<id>` is closed — closure-check (see `jig-system.md` §Validation-test requirement)
- Exploratory-test item with ID `<id>` is closed — closure-check (see `jig-system.md` §Validation-test requirement)
