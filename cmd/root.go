...
func printCommands() {
	...
	fmt.Println("  kerf triage            Drift report for the bead store")
	fmt.Println("  kerf pin <codename> <bead-id>  Pin a bead to a specific work")
	fmt.Println("  kerf work edit <codename>      Edit a work's bead-attachment config")
